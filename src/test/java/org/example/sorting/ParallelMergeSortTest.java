...
@DisplayName("Tests class ParallelMergeSort")
public class ParallelMergeSortTest {
    ...
    void testSortBooksByPageCount() throws IOException {
        ...
        ParallelMergeSort<Book> bookSorter = new ParallelMergeSort<>();
    ...
    void testSortReadersByAge() throws IOException {
        ...
        ParallelMergeSort<Reader> readerSorter = new ParallelMergeSort<>();
